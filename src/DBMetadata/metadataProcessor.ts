...
function tableInToRef (toRef: { [key: string]: any}, tblCol: DBMetadata) {
    return toRef.hasOwnProperty(tblCol.tableName) && toRef[tblCol.tableName].hasOwnProperty(tblCol.columnName);
}
