...
class MutationBuilder {
	...
	private buildMutationSignature (table: ProcessedTable, idField: ProcessedField, mutationType: string) {
	...
	private checkType(fieldType: string) {
		if (fieldType === "Number") return "Int";
		else return fieldType;
	}

	private checkRequired(required: boolean) {
		if (required) return "!";
		return "";
	}

	private buildTypeParams (table: ProcessedTable, idField: ProcessedField, mutationType: string) {
	...
	private buildReturnValues (table: ProcessedTable) {
		let mut = "";
